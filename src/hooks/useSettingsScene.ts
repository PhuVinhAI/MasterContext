...
export function useSettingsScene() {
  const {
    ...
    useShallow((state) => ({
      ...
      exportClaudeMode: state.exportClaudeMode,
      exportDummyLogic: state.exportDummyLogic,
      alwaysApplyText: state.alwaysApplyText,
      appendIdePrompt: state.appendIdePrompt,
      appendGroupPrompt: state.appendGroupPrompt,
      appendJulesPrompt: state.appendJulesPrompt,
