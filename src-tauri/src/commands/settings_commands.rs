...
#[command]
pub fn set_export_dummy_logic_setting(
    app: AppHandle,
    path: String,
    profile_name: String,
    enabled: bool,
    ...
    let mut project_data = file_cache::load_project_data(&app, &path, &profile_name)?;
    project_data.export_dummy_logic = Some(enabled);
    file_cache::save_project_data(&app, &path, &profile_name, &project_data)
}
...
#[command]
pub fn set_append_kilo_prompt_setting(
    app: AppHandle,
    path: String,
    profile_name: String,
    enabled: bool,
    ...
    let mut project_data = file_cache::load_project_data(&app, &path, &profile_name)?;
    project_data.append_kilo_prompt = Some(enabled);
    file_cache::save_project_data(&app, &path, &profile_name, &project_data)
}
